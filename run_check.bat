...
REM Проверяем наличие lib/vless_checker.py
if not exist "lib\\vless_checker.py" (
    echo [ERROR] Файл lib\\vless_checker.py не найден!
    pause
    exit /b 1
)
...
echo [SUCCESS] Запуск vless_checker...
